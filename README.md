...
|[Thermostat](https://github.com/SecretSurfSpot/thermostat)| 5 days| Initially created during pair-programming sessions.
I rewrote this Single Page Application, to gain a better understanding of event listeners, how they can be used alongside JavaScript, to create an interactive Single Page Application.
The application also makes a GET call to an external API.
Thermostat is built with JavaScript and Jasmine (testing framework), using BDD, TDD and OOP principles.| JavaScript, Jasmine|
